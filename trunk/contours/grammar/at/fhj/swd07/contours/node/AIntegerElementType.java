...
public final class AIntegerElementType extends PElementType
{
    private TInteger _integer_;

    public AIntegerElementType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AIntegerElementType(
            cloneNode(this._integer_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAIntegerElementType(this);
    }
