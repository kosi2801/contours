...
public final class AStaticTextComponentElementType extends PComponentElementType
{
    private TCharacterLiteral _characterLiteral_;

    public AStaticTextComponentElementType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStaticTextComponentElementType(
            cloneNode(this._characterLiteral_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAStaticTextComponentElementType(this);
    }
