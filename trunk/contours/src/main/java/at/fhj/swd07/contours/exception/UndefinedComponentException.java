...
public class UndefinedComponentException extends SemanticException {

    /**
     */
    private static final long serialVersionUID = -2170180014393747776L;

    public UndefinedComponentException(String identifier) {
        super("Component '" + identifier + "' used but never defined", 0, 0);
    }
}
